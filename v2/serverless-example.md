# Tutorial: Create a serverless Hello World application<a name="serverless-example"></a>
...
For more information, see [Getting started with the AWS CDK](getting-started.md).
...
+ [Learn AWS CDK core concepts](core-concepts.md) for an overview of core concepts of the AWS CDK.
...
Congratulations, you have successfully created, deployed, and interacted with your application using the AWS CDK\$1 
...
### Error: \$1“message”: “Internal server error”\$1%<a name="w94aac85c11c55b5"></a>
