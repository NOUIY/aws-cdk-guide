# Import an existing AWS CloudFormation template<a name="use-cfn-template"></a>
...
**Topics**
+ [Import an AWS CloudFormation template](#w94aac53c46c19)
+ [Access imported resources](#use-cfn-template-cfninclude-access)
+ [Replace parameters](#use-cfn-template-cfninclude-params)
+ [Import other template elements](#use-cfn-template-cfninclude-other)
+ [Import nested stacks](#use-cfn-template-cfninclude-nested)

## Import an AWS CloudFormation template<a name="w94aac53c46c19"></a>
...
## Access imported resources<a name="use-cfn-template-cfninclude-access"></a>
...
## Replace parameters<a name="use-cfn-template-cfninclude-params"></a>
...
## Import other template elements<a name="use-cfn-template-cfninclude-other"></a>
...
## Import nested stacks<a name="use-cfn-template-cfninclude-nested"></a>
